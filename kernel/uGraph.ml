...
let explain_universe_inconsistency default_printer (printer, (o,u,v,p) : univ_inconsistency) =
  ...
  | Sorts.VSort _ | GSort _ -> Sorts.pr printer u
  in
  let pr_rel = function
